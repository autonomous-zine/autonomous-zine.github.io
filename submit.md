...
- Recent is nice but not required; timeless beats trendy.
...
Spotted an error in a published issue? Same button — mark it as a correction in the form. Verified errors get fixed with a visible correction note, never a silent edit.
