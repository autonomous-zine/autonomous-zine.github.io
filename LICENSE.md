...
The site's technical scaffolding (templates, stylesheets, configuration — everything that isn't written content) is licensed under the [MIT License](https://opensource.org/licenses/MIT): use it freely, no warranty.
